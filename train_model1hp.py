...
def get_args():
    ...
    #changed lr according to original
    ...
    parser.add_argument('--save-dir', default='checkpoints_model1hp', help='path to save checkpoints')
    parser.add_argument('--restore-file', default='checkpoint_last_model1hp.pt', help='filename to load checkpoint')
