...
def get_args():
    ...
    parser.add_argument('--save-dir', default='checkpoints_model2hp', help='path to save checkpoints')
    parser.add_argument('--restore-file', default='checkpoint_last_model2hp.pt', help='filename to load checkpoint')
